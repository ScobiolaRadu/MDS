...
public class Boss2 : MonoBehaviour
{
    ...
    public HealthBarBoss2 healthBar;
    ...
    public void TakeDamage(int damage)
    {
        ...
        healthBar.UpdateHealthBar(boss2, hpBar);
    ...
    void Die()
    {
        ...
        boss2.gameObject.tag = "Untagged";

       if (GlobalAchievements.triggerAch05 == false)
        {
            GlobalAchievements.triggerAch05 = true;
        }
